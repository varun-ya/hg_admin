...
export const atRiskUsers: AtRiskUser[] = [
  { id: "STU-8801", name: "Aarav Sharma", email: "aarav.s@gmail.com", avatar: "https://i.pravatar.cc/150?img=11", type: "student", engagementScore: 32, lastActive: "5 days ago", riskLevel: "critical", riskFactors: ["No classes in 14 days", "Whiteboard usage dropped 90%", "Skipped 3 scheduled sessions"], nudgeSent: true, nudgeChannel: "WhatsApp" },
  { id: "STU-7702", name: "Meera Joshi", email: "meera.j@outlook.com", avatar: "https://i.pravatar.cc/150?img=25", type: "student", engagementScore: 45, lastActive: "3 days ago", riskLevel: "high", riskFactors: ["Chat frequency dropped 70%", "Negative review submitted"], nudgeSent: true, nudgeChannel: "WhatsApp" },
  { id: "TCH-3302", name: "Ravi Kumar", email: "ravi.k@homeguru.in", avatar: "https://i.pravatar.cc/150?img=12", type: "teacher", engagementScore: 51, lastActive: "2 days ago", riskLevel: "high", riskFactors: ["Booking rate dropped 60%", "Response time increased 3x"], nudgeSent: false, nudgeChannel: null },
  { id: "STU-9903", name: "Priya Nair", email: "priya.n@gmail.com", avatar: "https://i.pravatar.cc/150?img=32", type: "student", engagementScore: 58, lastActive: "1 day ago", riskLevel: "medium", riskFactors: ["Session duration declining", "Feedback scores dropping"], nudgeSent: false, nudgeChannel: null },
  { id: "TCH-4401", name: "Sneha Reddy", email: "sneha.r@homeguru.in", avatar: "https://i.pravatar.cc/150?img=47", type: "teacher", engagementScore: 62, lastActive: "Today", riskLevel: "medium", riskFactors: ["Fewer slots opened this week"], nudgeSent: false, nudgeChannel: null },
  { id: "STU-6604", name: "Carlos Vega", email: "carlos.v@gmail.com", avatar: "https://i.pravatar.cc/150?img=15", type: "student", engagementScore: 68, lastActive: "Today", riskLevel: "low", riskFactors: ["Slight dip in quiz completion"], nudgeSent: false, nudgeChannel: null },
];
